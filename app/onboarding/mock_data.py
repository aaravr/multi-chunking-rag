...
EVALUATION_PLAN = {
    "target_mode": "shadow",
    "modes": {
        "sandbox": {"label": "Sandbox", "icon": '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="3" width="16" height="16" rx="2" stroke="#666" stroke-width="1.5" fill="none"/><line x1="7" y1="8" x2="15" y2="8" stroke="#666" stroke-width="1.2"/><line x1="7" y1="11" x2="13" y2="11" stroke="#666" stroke-width="1.2"/><line x1="7" y1="14" x2="11" y2="14" stroke="#666" stroke-width="1.2"/></svg>', "description": "Internal testing only. No production data flow.", "min_accuracy": 0.0},
        "pilot": {"label": "Pilot", "icon": '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="8" stroke="#666" stroke-width="1.5" fill="none"/><circle cx="11" cy="11" r="3" stroke="#666" stroke-width="1.5" fill="none"/><line x1="11" y1="3" x2="11" y2="6" stroke="#666" stroke-width="1.2"/><line x1="11" y1="16" x2="11" y2="19" stroke="#666" stroke-width="1.2"/><line x1="3" y1="11" x2="6" y2="11" stroke="#666" stroke-width="1.2"/><line x1="16" y1="11" x2="19" y2="11" stroke="#666" stroke-width="1.2"/></svg>', "description": "Limited scope with selected reviewers. 5–10% of volume.", "min_accuracy": 0.80},
        "shadow": {"label": "Shadow", "icon": '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="3" width="14" height="16" rx="2" stroke="#666" stroke-width="1.5" fill="none"/><rect x="4" y="3" width="14" height="16" rx="2" stroke="#666" stroke-width="1.5" fill="none" stroke-dasharray="3 2" transform="translate(1.5,1.5)" opacity="0.4"/></svg>', "description": "Full volume, parallel to manual process. No downstream impact.", "min_accuracy": 0.85},
        "canary": {"label": "Canary", "icon": '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11 3 L13.5 8 L19 9 L15 13 L16 19 L11 16 L6 19 L7 13 L3 9 L8.5 8 Z" stroke="#666" stroke-width="1.5" fill="none" stroke-linejoin="round"/></svg>', "description": "Small fraction of live traffic. Monitored with auto-rollback.", "min_accuracy": 0.90},
        "production": {"label": "Production", "icon": '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="8" stroke="#666" stroke-width="1.5" fill="none"/><polyline points="7,11 10,14 15,8" stroke="#666" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>', "description": "Full production deployment. All quality gates must pass.", "min_accuracy": 0.95},
    },
    "quality_gates": [
